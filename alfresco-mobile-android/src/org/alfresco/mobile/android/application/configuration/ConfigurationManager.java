...
public final class ConfigurationManager
{
    ...
    private final Map<Long, ConfigurationContext> configContextMap = new HashMap<Long, ConfigurationContext>();
    ...
    public static final List<String> DATA_DICTIONNARY_LIST = new ArrayList<String>(8)
...

        {
            ...
            {
                return configContextMap != null && account != null && configContextMap.containsKey(account.getId());
            }
