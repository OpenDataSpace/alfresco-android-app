...
public class SiteMembershipLoaderCallback implements LoaderCallbacks<LoaderResult<Site>>
{
    ...
    public void onLoadFinished(Loader<LoaderResult<Site>> loader, LoaderResult<Site> result)
    {
        ...
        if (!result.hasException())
        {
            ...
            if (loader instanceof SiteMembershipLoader && site != null && ((SiteMembershipLoader) loader).isJoining())
            {
                messageId =
                        (SiteVisibility.PUBLIC.equals(site.getVisibility())) ? R.string.action_join_site_validation :
            ...
            else
            {
                ...
                if (fragment instanceof BrowserSitesFragment &&
                        BrowserSitesFragment.TAB_MY_SITES.equals(((BrowserSitesFragment) fragment).getCurrentTabId()))
                {
