...
public final class MimeTypeSchema
{
    ...
    public static final String[] COLUMN_ALL =
            {COLUMN_ID, COLUMN_EXTENSION, COLUMN_TYPE, COLUMN_SUBTYPE, COLUMN_DESCRIPTION, COLUMN_SMALL_ICON,
                    COLUMN_LARGE_ICON};

    private static final String QUERY_TABLE_CREATE =
            "CREATE TABLE " + TABLENAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_EXTENSION +
                    " TEXT ," + COLUMN_TYPE + " TEXT NOT NULL," + COLUMN_SUBTYPE + " TEXT NOT NULL," +
                    COLUMN_DESCRIPTION + " TEXT NOT NULL," + COLUMN_SMALL_ICON + " TEXT," + COLUMN_LARGE_ICON +
                    " TEXT" + ");";
    ...
    private static void create(SQLiteDatabase db)
    {
        ...
        insert(db, "dotm", MimeType.TYPE_APPLICATION, "vnd.ms-word.template.macroenabled.12",
                "Microsoft Word 2007 macro-enabled document template", "R.drawable.mime_doc",
                "R.drawable.mime_256_doc");
        ...
        insert(db, "mdb", MimeType.TYPE_APPLICATION, "x-msaccess", "Microsoft Access", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "nsf", MimeType.TYPE_APPLICATION, "vnd.lotus-notes", "Lotus Notes", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "odb", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.database", "OpenDocument Database",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odc", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.chart", "OpenDocument Chart", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "odp", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.presentation", "OpenDocument Presentation",
                "R.drawable.mime_odp", "R.drawable.mime_256_odp");
        ...
        insert(db, "ppa", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Microsoft PowerPoint", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        ...
        insert(db, "ppt", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Microsoft PowerPoint", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        ...
        insert(db, "wps", MimeType.TYPE_APPLICATION, "vnd.ms-works", "Microsoft Works", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "wri", MimeType.TYPE_APPLICATION, "x-mswrite", "Microsoft Wordpad", ICON_GENERIC,
                ICON_GENERIC_LARGE);
                              ...
                              String smallIcon, String largeIcon)
    {
        ContentValues insertValues =
                MimeTypeManager.createContentValues(extension, type, subtype, description, smallIcon, largeIcon);
