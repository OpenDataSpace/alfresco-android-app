...
public class LoadSessionCallBack extends AbstractBatchOperationCallback<AlfrescoSession>
{
    ...
    public void onError(Operation<AlfrescoSession> task, Exception e)
    {
        ...
        case Account.TYPE_ODS_CMIS:
            ...
            int msgId = SessionExceptionHelper.getMessageId(context, e);
            ...
            broadcastIntent.putExtra(SimpleAlertDialogFragment.PARAM_MESSAGE, msgId);

            if (msgId == R.string.error_session_unauthorized)
            {
                broadcastIntent
                        .putExtra(SimpleAlertDialogFragment.PARAM_CUSTOM_BUTTON, R.string.account_change_password);
            }
    ...
    private void saveData(Operation<AlfrescoSession> task, AlfrescoSession session)
    {
        ...
        case Account.TYPE_ALFRESCO_CLOUD:
            ...
            {
                acc = AccountManager.update(context, acc.getId(), acc.getDescription(), acc.getUrl(), acc.getUsername(),
                        ...
                        acc.getIsPaidAccount() ? 1 : 0, acc.getProtocolType());
            }
