...
public final class SynchroSchema extends OperationSchema
{
    ...
    private static final String[] COLUMNS_SYNC =
            {COLUMN_CONTENT_URI, COLUMN_ANALYZE_TIMESTAMP, COLUMN_SERVER_MODIFICATION_TIMESTAMP,
                    COLUMN_LOCAL_MODIFICATION_TIMESTAMP, COLUMN_IS_FAVORITE, COLUMN_IS_ROOT, COLUMN_DOC_SIZE_BYTES};
    ...
    private static final String QUERY_TABLE_CREATE =
            "CREATE TABLE IF NOT EXISTS " + TABLENAME + " (" + QUERY_CREATE_COLUMNS + "," + COLUMN_CONTENT_URI +
                    " TEXT," + COLUMN_ANALYZE_TIMESTAMP + " LONG," + COLUMN_SERVER_MODIFICATION_TIMESTAMP + " LONG," +
                    COLUMN_LOCAL_MODIFICATION_TIMESTAMP + " LONG," + COLUMN_IS_FAVORITE + " INT," + COLUMN_IS_ROOT +
                    " INT," + COLUMN_DOC_SIZE_BYTES + " LONG" + ");";

    // Update database to add Sync Folder column
    // DB version 5.
    private static final String QUERY_SYNC_FOLDER_COLUM_1 =
            "ALTER TABLE " + TABLENAME + " ADD COLUMN " + COLUMN_IS_FAVORITE + " INT DEFAULT 1;";

    private static final String QUERY_SYNC_FOLDER_COLUM_2 =
            "ALTER TABLE " + TABLENAME + " ADD COLUMN " + COLUMN_IS_ROOT + " INT DEFAULT 0;";

    private static final String QUERY_SYNC_FOLDER_COLUM_3 =
            "ALTER TABLE " + TABLENAME + " ADD COLUMN " + COLUMN_DOC_SIZE_BYTES + " LONG DEFAULT 0;";
    ...
    public static void onUpgrade(Context context, SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        else if (oldVersion < DatabaseVersionNumber.VERSION_1_4_0)
        {
