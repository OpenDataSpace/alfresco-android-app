    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener
    {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY)
        {
            return mScrollEnabled && !(e1 == null || e2 == null) &&
                    !(e1.getPointerCount() > 1 || e2.getPointerCount() > 1) && !mScaleDetector.isInProgress() &&
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY)
        {
            return mScrollEnabled && !(e1.getPointerCount() > 1 || e2.getPointerCount() > 1) &&
                    !mScaleDetector.isInProgress() && getScale() != 1f &&
                    ImageViewTouch.this.onFling(e1, e2, velocityX, velocityY);
