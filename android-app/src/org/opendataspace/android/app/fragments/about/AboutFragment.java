 ...
 */
        ...
        if (feedback != null) {
            final CharSequence mailto = getText(R.string.copyright_mailto);
            ...
            final CharSequence text = Html.fromHtml(source);
            feedback.setText(text);
            final MovementMethod movement = LinkMovementMethod.getInstance();
            feedback.setMovementMethod(movement);
        }
