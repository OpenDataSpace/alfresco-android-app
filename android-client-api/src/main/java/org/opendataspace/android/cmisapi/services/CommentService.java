...
public interface CommentService extends Service
{
     ...
     * @throws AlfrescoServiceException : {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#GENERAL_NOT_FOUND GENERAL_NOT_FOUND} : if node doesn't
     *             exist.
