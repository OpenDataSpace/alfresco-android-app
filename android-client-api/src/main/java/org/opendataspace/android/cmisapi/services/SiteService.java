 ...
 ******************************************************************************/
package org.opendataspace.android.cmisapi.services;
...
public interface SiteService extends Service
{
     ...
     *            paging results
     *            {@link org.opendataspace.android.cmisapi.model.ListingContext
     *            ListingContext}
     ...
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_NOT_FAVORITED
     *             SITE_NOT_FAVORITED}
     */
     ...
     * @throws AlfrescoServiceException : if the request can not be completed
     *             successfully an exception is thrown with error code
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_NOT_UNFAVORITED
     ...
     *             with error code
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_ALREADY_MEMBER
     *             SITE_ALREADY_MEMBER}. <br/>
     *             If the request fails for any other reason an exception is
     *             thrown with error code
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_NOT_JOINED
     *             SITE_NOT_JOINED}.
     */
     ...
     * @throws AlfrescoServiceException : If the request can not be completed
     *             successfully an exception is thrown with error code
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_CANCEL_JOINED
     *             SITE_CANCEL_JOINED}.
     */
     ...
     * @throws AlfrescoServiceException : If the request can not be completed
     *             successfully an exception is thrown with error code
     *             {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_NOT_LEFT
     *             SITE_NOT_LEFT} or {@link org.opendataspace.android.cmisapi.exceptions.ErrorCodeRegistry#SITE_LAST_MANAGER
