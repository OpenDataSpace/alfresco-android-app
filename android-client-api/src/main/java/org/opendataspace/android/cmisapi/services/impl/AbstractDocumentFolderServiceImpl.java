...
import org.opendataspace.android.cmisapi.model.impl.PermissionsImpl;
...
public abstract class AbstractDocumentFolderServiceImpl extends AlfrescoService implements DocumentFolderService
{
    ...
    /** {@inheritDoc} */
    @Override
    public org.opendataspace.android.cmisapi.model.ContentStream getContentStream(Document document)
    {
        if (isObjectNull(document)) { throw new IllegalArgumentException(String.format(
                Messagesl18n.getString("ErrorCodeRegistry.GENERAL_INVALID_ARG_NULL"), "document")); }
        ...
        try
        {
            ...
            ObjectService objectService = cmisSession.getBinding().getObjectService();
            org.opendataspace.android.cmisapi.model.ContentStream cf = new ContentStreamImpl(document.getName(),
    ...
    /** {@inheritDoc} */
    public org.opendataspace.android.cmisapi.model.ContentStream downloadContentStream(String identifier)
    {
        try
        {
    ...
    public abstract org.opendataspace.android.cmisapi.model.ContentStream getRenditionStream(String identifier,
            String type);

    /** {@inheritDoc} */
    public org.opendataspace.android.cmisapi.model.ContentStream getRenditionStream(Node node, String type)
    {
        if (isObjectNull(node)) { throw new IllegalArgumentException(String.format(
                Messagesl18n.getString("ErrorCodeRegistry.GENERAL_INVALID_ARG_NULL"), "node")); }
