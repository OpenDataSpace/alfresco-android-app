...
public class OnPremiseDocumentFolderServiceImpl extends AbstractDocumentFolderServiceImpl
{
    ...
    @Override
    /** {@inheritDoc} */
    public org.opendataspace.android.cmisapi.model.ContentStream getRenditionStream(String identifier, String type)
    {
        try
        {
            ...
            org.opendataspace.android.cmisapi.model.ContentStream cf;
