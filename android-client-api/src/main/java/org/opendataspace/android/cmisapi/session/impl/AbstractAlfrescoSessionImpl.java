 ...
 ******************************************************************************/
package org.opendataspace.android.cmisapi.session.impl;
...
public abstract class AbstractAlfrescoSessionImpl implements AlfrescoSession, Parcelable
{
    ...
    public static final String DEFAULT_CACHE_FOLDER_PATH = "/sdcard/Android/data/org.opendataspace.android.app/cache";
    ...
    protected void initSettings(String url, String username, String password, Map<String, Serializable> settings)
    {
        ...
        if (!tmpSettings.containsKey(SessionParameter.AUTHENTICATION_PROVIDER_CLASS))
        {
            tmpSettings.put(SessionParameter.AUTHENTICATION_PROVIDER_CLASS,
                    "org.opendataspace.android.cmisapi.session.authentication.impl.PassthruAuthenticationProviderImpl");
        }
     ...
     * the session.
     */
    private static final String BINDING_TYPE = "org.opendataspace.internal.binding";
    ...
    private static final String BINDING_URL = "org.opendataspace.binding.internal.url";

    private static final String BASE_URL = "org.opendataspace.binding.internal.baseurl";

    protected static final String USER = "org.opendataspace.internal.credential.user";

    protected static final String PASSWORD = "org.opendataspace.internal.credential.password";
    ...
    /**
     * @return Returns
     *         {@link org.opendataspace.android.cmisapi.model.RepositoryInfo
