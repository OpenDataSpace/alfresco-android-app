...
import org.opendataspace.android.cmisapi.services.impl.onpremise.OnPremiseServiceRegistry;
...
public class RepositorySessionImpl extends RepositorySession
{
     ...
     * {@link org.opendataspace.android.cmisapi.session.SessionSettings
     * SessionSettings}.
     * 
    ...
    /**
     * @see org.opendataspace.android.cmisapi.session.RepositorySession#authenticate(String,
     *      String)
     */
